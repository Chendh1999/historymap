...
if __name__ == '__main__':
    result = ReadVectorFile(
        r'E:\develop_gis\map website\data\V6 Time Series Prefecture Points\v6_time_pref_pts_utf_wgs84\v6_time_pref_pts_utf_wgs84.shp')
    f_new = open(
        r'E:\develop_gis\map website\data\V6 Time Series Prefecture Points\v6_time_pref_pts_utf_wgs84\v6_time_pref_pts_utf_wgs84.txt',
        'a', encoding='utf-8')
    for r in result:
        for p in r:
            f_new.write(p + '\t')
